...
// Audit workspace — logic in useAuditWorkspace; this file is display only. The activity_tracking
// capability guards the nav/route upstream; user:read guards the body (AppPermissionGate).
const {
  draft,
  status,
  errorMessage,
