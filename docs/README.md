...
This folder is the human-readable source of truth for this frontend.
...
Use the progress docs to understand what is already implemented, which backend contracts the UI depends on, and what the next execution steps should be.
